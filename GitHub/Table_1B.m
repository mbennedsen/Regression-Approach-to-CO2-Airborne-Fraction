%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This script will produce Table 1 (right panel) of the main paper. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
indx = 34:64; % 34:64 will select the recent sample (1992-2022)
...
%% Print
disp(' ')
disp('Table 1B (recent sample, 1992-2022): ')
